...
//	out_scene->objects[2] = new_cylinder((cl_float3){{0, 0, 0}},(cl_float3) {{45, 0, 0}}, 1, 5, COL_GREEN, 200);
	out_scene->objects[0] = new_cone((cl_float3){{0, 0, 0}}, 1.f, (cl_float3){{0, 0, 0}}, 15 , 5, 200, COL_YELLOW);
//	out_scene->objects[3] = new_cylinder((cl_float3){{0, 0, 0}},(cl_float3) {{0, 0, 90}}, 1, 5, COL_MAGNETA, 200);
	out_scene->objects[1] = new_plane((cl_float3){{0, -4, 0}}, (cl_float3){{0, 1, 0}}, COL_WHITE, 500);

	out_scene->lights_nbr = 2;
